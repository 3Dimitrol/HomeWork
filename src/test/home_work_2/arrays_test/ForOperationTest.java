...
public class ForOperationTest {
    ...
    public static int[] arrrays(int[] x1) {


        IArraysOperation arr1 = new ArraysIteration();
        int[] arrays = x1; //[6] - 1,2,3,4,5,6
    //  return arr1.iterationFor(arrays);
    //  return arr1.twoElementsFor(arrays);
      return arr1.reversFor(arrays);
    ...
    public void test2(){
        int[] arr1 = {1, 2, 3, 4, 5, 6};
        int[] arr2 = ForOperationTest.arrrays(arr1);
    ...
    public void test3(){
        int[] arr1 = {1, 2, 3, 4, 5, 6};
        int[] arr3 = ForOperationTest.arrrays(arr1);
