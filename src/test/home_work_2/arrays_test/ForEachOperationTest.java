...
public class ForEachOperationTest {
    ...
    public static int[] stat(int[] x1) {


        IArraysOperation arr1 = new ArraysIteration();
        int[] arrays = x1;   //[6] - 1, 2, 3, 4, 5, 6
    //   return arr1.iterationForeach(arrays);
    //   return arr1.twoElementsForeach(arrays);
       return arr1.reversForeach(arrays);
    ...
    public void test2(){
        int[] arr1 = {1, 2, 3, 4, 5, 6};
        int[] arr2 = ForEachOperationTest.stat(arr1);
    ...
    public void test3(){
        int[] arr1 = {1, 2, 3, 4, 5, 6};
        int[] arr3 = ForEachOperationTest.stat(arr1);
